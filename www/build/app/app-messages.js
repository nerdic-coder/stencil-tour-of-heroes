...
class MyApp {
    ...
    render() {
        return (h("div", null,
            ...
            h("nav", null,
                h("stencil-route-link", { url: "/dashboard" }, "Dashboard"),
                h("stencil-route-link", { url: "/heroes" }, "Heroes")),
            h("main", null,
                h("stencil-router", null,
                    h("stencil-route", { url: '/', component: 'app-dashboard', exact: true }),
                    h("stencil-route", { url: '/dashboard', component: 'app-dashboard', exact: true }),
                    h("stencil-route", { url: '/heroes', component: 'app-heroes', exact: true }),
                    h("stencil-route", { url: '/detail/:id', component: 'app-hero-details', exact: true }))),
            h("app-messages", null)));
    }
