...
import { d as __extends, e as tryCatch, f as errorObject, g as OuterSubscriber, h as subscribeToResult, i as async, j as Subscriber, k as isScheduler, l as Subscription, m as isArray, n as from, o as Notification, a as Observable, p as noop, q as isFunction, r as EmptyError, s as ArgumentOutOfRangeError, t as empty, u as map, v as Subject, w as BehaviorSubject, x as AsyncSubject, y as ReplaySubject, z as refCount, a0 as fromArray, a1 as scalar, a2 as asap, a3 as isNumeric, a4 as TimeoutError, a5 as throwError } from './chunk-2019fd7d.js';
...
class HeroeSearch {
    ...
    render() {
        return (h("div", { class: 'app-hero-search', id: "search-component" },
            h("h4", null, "Hero Search"),
            h("input", { type: "text", id: "search-box", onKeyUp: (event) => this.search(event) }),
            h("ul", { class: "search-result" }, this.heroes ? (this.heroes.map((hero) => h("li", null,
                h("stencil-route-link", { url: `/detail/${hero.id}` },
                    h("span", { class: "badge" }, hero.id),
                    " ",
                    hero.name)))) : (null))));
    }
    static get is() { return "app-hero-search"; }
    static get properties() { return {
        "heroes": {
            "state": true
        }
    }; }
    static get style() { return "/* HeroSearch private styles */\n    .search-result li {\n      border-bottom: 1px solid gray;\n      border-left: 1px solid gray;\n      border-right: 1px solid gray;\n      width:195px;\n      height: 16px;\n      padding: 5px;\n      background-color: white;\n      cursor: pointer;\n      list-style-type: none;\n    }\n\n    .search-result li:hover {\n      background-color: #607D8B;\n    }\n\n    .search-result li a {\n      color: #888;\n      display: block;\n      text-decoration: none;\n    }\n\n    .search-result li a:hover {\n      color: white;\n    }\n    .search-result li a:active {\n      color: white;\n    }\n    #search-box {\n      width: 200px;\n      height: 20px;\n    }\n\n\n    ul.search-result {\n      margin-top: 0;\n      padding-left: 0;\n    }"; }
}

export { Dashboard as AppDashboard, HeroeSearch as AppHeroSearch };
